...
namespace Nop.Plugin.Payments.PhonePe
{
    ...
    public class PhonePePaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        private IDictionary<string, string> CreateQueryParameters(PostProcessPaymentRequest postProcessPaymentRequest)
        {
            ...
            {
                //PhonePe ID or an email address associated with your PhonePe account
                ...
                ["return"] = $"{storeLocation}Plugins/PaymentPhonePe/HandlePostBack",
        ...
        private void AddItemsParameters(IDictionary<string, string> parameters, PostProcessPaymentRequest postProcessPaymentRequest)
        {
            ...
            if (cartTotal > postProcessPaymentRequest.Order.OrderTotal)
            {
                ...
                //gift card or rewarded point amount applied to cart in nopCommerce - shows in PhonePe as "discount"
            ...
            _genericAttributeService.SaveAttribute(postProcessPaymentRequest.Order, PhonePeHelper.OrderTotalSentToPhonePe, roundedCartTotal);
        }
        ...
        public override void Install()
        {
            ...
            {
                ["Plugins.Payments.PhonePe.Fields.SandboxURL"] = "SandboxURL",
                ["Plugins.Payments.PhonePe.Fields.Sandbox.Hint"] = "Enter Sandbox URL provided by PhonePe.",
                ["Plugins.Payments.PhonePe.Fields.ProductionURL"] = "ProductionURL",
                ["Plugins.Payments.PhonePe.Fields.ProductionURL.Hint"] = "Enter ProductionURL provided by PhonePe.",
                ["Plugins.Payments.PhonePe.Fields.MerchantId"] = "MerchantId",
                ["Plugins.Payments.PhonePe.Fields.MerchantId.Hint"] = "Enter MerchantId provided by PhonePe.",
                ["Plugins.Payments.PhonePe.Fields.Salt"] = "Salt",
                ["Plugins.Payments.PhonePe.Fields.Salt.Hint"] = "Enter Salt provided by PhonePe.",
                ["Plugins.Payments.PhonePe.Fields.RedirectionTip"] = "You will be redirected to PhonePe site to complete the order.",
                ["Plugins.Payments.PhonePe.Fields.UseSandbox"] = "Use Sandbox",
                ["Plugins.Payments.PhonePe.Fields.UseSandbox.Hint"] = "Check to enable Sandbox (testing environment).",
                ["Plugins.Payments.PhonePe.Instructions"] = @"
                    <p>
                ...
                ["Plugins.Payments.PhonePe.PaymentMethodDescription"] = "You will be redirected to PhonePe site to complete the payment",
                ["Plugins.Payments.PhonePe.RoundingWarning"] = "It looks like you have \"ShoppingCartSettings.RoundPricesDuringCalculation\" setting disabled. Keep in mind that this can lead to a discrepancy of the order total amount, as PhonePe only rounds to two decimals.",
        ...
        public override void Uninstall()
        {
            ...
            //locales
            _localizationService.DeletePluginLocaleResources("Plugins.Payments.PhonePe");
